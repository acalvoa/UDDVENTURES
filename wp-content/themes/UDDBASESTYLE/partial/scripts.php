...
<script src="<?php echo get_template_directory_uri(); ?>/base/js/lib/perfect-scrollbar.jquery.js"></script>
<script src="<?php echo get_template_directory_uri(); ?>/base/js/scripts.js"></script>
